...
//Functions
    ...
    virtual float PDF(const Intersection &isx, const glm::vec3 &woW, const glm::vec3 &wiW, BxDFType flags = BSDF_ALL) const;
    ...
    virtual glm::vec3 SampleAndEvaluateScatteredEnergy(const Intersection &isx, const glm::vec3 &woW, glm::vec3 &wiW_ret, float &pdf_ret, const float &rand1, const float &rand2, BxDFType &type, BxDFType flags = BSDF_ALL) const;
    ...
    float GetPDF(const glm::vec3 &wo, const glm::vec3 &wi) const;
