...
//Functions
    ...
    virtual glm::vec3 SampleAndEvaluateScatteredEnergy(const Intersection &isx, const glm::vec3 &woW, glm::vec3 &wiW_ret, float &pdf_ret, const float &rand1, const float &rand2, BxDFType &type, BxDFType flags) const;

    virtual float PDF(const Intersection &isx, const glm::vec3 &woW, const glm::vec3 &wiW, BxDFType flags) const;
};
