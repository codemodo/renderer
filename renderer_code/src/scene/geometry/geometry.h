...
//Functions
    ...
    virtual glm::vec3 SamplePhotonDirection(Intersection &isx, float rand1, float rand2) const;
    ...
    virtual Intersection GetSampledIntersection(float randX, float randY, const glm::vec3 &isx_normal) = 0;
